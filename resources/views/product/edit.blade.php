...
<body>
    <div class="container">
        <header style="margin-bottom: 2rem; text-align: left;">
            ...
            <h1 style="text-align: left; margin-top: 1rem;">✏️ Edit Product</h1>
        </header>
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" value="{{ old('title', $product->title) }}" placeholder="e.g. Premium Wireless Headphones" required>
                @error('title')
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" placeholder="Describe your product...">{{ old('description', $product->description) }}</textarea>
                @error('description')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                <label>Update Images <span style="font-weight: normal; color: var(--text-muted); font-size: 0.8rem;">(Optional - leave empty to keep current image)</span></label>
                <div class="file-input-wrapper">
                    ...
                    <label for="images" class="file-input-label">
                        <span>📁</span> Choose New Images (Click to browse)
                    </label>
                </div>
